 ...
 * 
 * Instantiation Service for the Twitter Source.
 */
public class TwitterSourceInstantiationService extends SourceInstantiationFacadeImpl {
	...
	public SourceServiceFacade instantiate() {
		// create a new twitter source and return it
		return instantiated(new TwitterSourceService());
	}
