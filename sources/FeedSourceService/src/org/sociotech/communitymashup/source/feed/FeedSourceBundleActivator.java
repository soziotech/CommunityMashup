 ...
 * 
 * Source dependent implementation of the FeedSourceBundleActivator.
 */
public class FeedSourceBundleActivator extends SourceBundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		super.start(bundleContext, new FeedSourceInstantiationService());
