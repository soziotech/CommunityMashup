...
/**
 * Source instantiation service for clean up sources. 
 * 
 * @author Peter Lachenmaier
 *
 */
public class CleanUpSourceInstantiationService extends SourceInstantiationFacadeImpl {
	...
	public SourceServiceFacade instantiate() {
		...
		return instantiated(new CleanUpSourceService());
	}
