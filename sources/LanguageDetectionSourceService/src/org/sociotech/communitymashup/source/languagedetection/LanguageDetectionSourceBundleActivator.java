 ...
 */
public class LanguageDetectionSourceBundleActivator extends SourceBundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		super.start(bundleContext, new LanguageDetectionSourceInstantiationService());
