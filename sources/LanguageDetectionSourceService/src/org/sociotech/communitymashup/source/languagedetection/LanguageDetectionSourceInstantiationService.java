...
/**
 * Source instantiation service for language detection sources. 
 * 
 * @author Peter Lachenmaier
 *
 */
public class LanguageDetectionSourceInstantiationService extends SourceInstantiationFacadeImpl {
	...
	public SourceServiceFacade instantiate() {
		...
		return instantiated(new LanguageDetectionSourceService());
	}
