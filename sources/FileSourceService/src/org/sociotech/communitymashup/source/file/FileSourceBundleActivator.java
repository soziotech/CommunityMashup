 ...
 * 
 * Source dependent implementation of the FileSourceBundleActivator.
 */
public class FileSourceBundleActivator extends SourceBundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		super.start(bundleContext, new FileSourceInstantiationService());
