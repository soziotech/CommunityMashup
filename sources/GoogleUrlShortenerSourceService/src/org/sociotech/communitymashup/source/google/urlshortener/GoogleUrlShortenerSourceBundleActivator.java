 ...
 */
public class GoogleUrlShortenerSourceBundleActivator extends SourceBundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		super.start(bundleContext, new GoogleUrlShortenerSourceInstantiationService());
	}
