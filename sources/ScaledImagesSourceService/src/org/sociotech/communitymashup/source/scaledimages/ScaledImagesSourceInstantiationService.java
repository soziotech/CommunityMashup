...
/**
 * Source instantiation of the scaled images source service. 
 * 
 */
public class ScaledImagesSourceInstantiationService extends SourceInstantiationFacadeImpl {
    ...
    public SourceServiceFacade instantiate() {
    	...
    	return instantiated(new ScaledImagesSourceService());
    }
