...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>View Ranking</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.sociotech.communitymashup.data.impl.ViewRankingImpl#getRankedInformationObject <em>Ranked Information Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ViewRankingImpl extends RankingImpl implements ViewRanking {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.VIEW_RANKING;
	}
		...
		if (rankedInformationObject != null && rankedInformationObject.eIsProxy()) {
			...
			if (rankedInformationObject != oldRankedInformationObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataPackage.VIEW_RANKING__RANKED_INFORMATION_OBJECT, oldRankedInformationObject, rankedInformationObject));
			}
		}
	...
	public NotificationChain basicSetRankedInformationObject(InformationObject newRankedInformationObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DataPackage.VIEW_RANKING__RANKED_INFORMATION_OBJECT, oldRankedInformationObject, newRankedInformationObject);
	...
	public void setRankedInformationObject(InformationObject newRankedInformationObject) {
		if (newRankedInformationObject != rankedInformationObject) {
			...
			if (rankedInformationObject != null)
				msgs = ((InternalEObject)rankedInformationObject).eInverseRemove(this, DataPackage.INFORMATION_OBJECT__VIEW_RANKINGS, InformationObject.class, msgs);
			if (newRankedInformationObject != null)
				msgs = ((InternalEObject)newRankedInformationObject).eInverseAdd(this, DataPackage.INFORMATION_OBJECT__VIEW_RANKINGS, InformationObject.class, msgs);
			msgs = basicSetRankedInformationObject(newRankedInformationObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.VIEW_RANKING__RANKED_INFORMATION_OBJECT, newRankedInformationObject, newRankedInformationObject));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataPackage.VIEW_RANKING__RANKED_INFORMATION_OBJECT:
				if (rankedInformationObject != null)
					msgs = ((InternalEObject)rankedInformationObject).eInverseRemove(this, DataPackage.INFORMATION_OBJECT__VIEW_RANKINGS, InformationObject.class, msgs);
	...
	/**
	 * Generates an EObjectCondition to check whether an Object is of the type ViewRanking.
	 * 
	 * @return An EObjectCondition whether the Object is of the type ViewRanking.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		return new EObjectTypeRelationCondition(DataPackageImpl.eINSTANCE.getViewRanking());
	}
	...
	protected Object setFeature(String featureName, Object value) throws WrongArgException, UnknownOperationException {
		if ( featureName.equalsIgnoreCase("rankedInformationObject") ) {
				...
				try {
					...
					throw new WrongArgException("ViewRanking.setFeature", "org.sociotech.communitymashup.data.InformationObject",value.getClass().getName());
				}
