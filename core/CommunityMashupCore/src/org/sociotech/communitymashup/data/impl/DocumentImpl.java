 ...
 * @generated
 */
public class DocumentImpl extends AttachmentImpl implements Document {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.DOCUMENT;
	}

	/**
	 * Generates an EObjectCondition to check whether an Object is of the type Document.
	 * 
	 * @return An EObjectCondition whether the Object is of the type Document.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		return new EObjectTypeRelationCondition(DataPackageImpl.eINSTANCE.getDocument());
	}
