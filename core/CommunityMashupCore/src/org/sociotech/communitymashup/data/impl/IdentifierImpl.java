 ...
 * <ul>
 *   <li>{@link org.sociotech.communitymashup.data.impl.IdentifierImpl#getKey <em>Key</em>}</li>
 *   <li>{@link org.sociotech.communitymashup.data.impl.IdentifierImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.sociotech.communitymashup.data.impl.IdentifierImpl#getIdentified <em>Identified</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IdentifierImpl extends ItemImpl implements Identifier {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getIdentified() <em>Identified</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getIdentified()
	 * @generated
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.IDENTIFIER;
	}
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.IDENTIFIER__KEY, oldKey, key));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.IDENTIFIER__VALUE, oldValue, value));
	}
	 ...
	 * @generated
	 */
	public Item getIdentified() {
		if (identified != null && identified.eIsProxy()) {
			InternalEObject oldIdentified = (InternalEObject)identified;
			identified = (Item)eResolveProxy(oldIdentified);
			if (identified != oldIdentified) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataPackage.IDENTIFIER__IDENTIFIED, oldIdentified, identified));
			}
		}
		return identified;
	}
	 ...
	 * @generated
	 */
	public Item basicGetIdentified() {
		return identified;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIdentified(Item newIdentified, NotificationChain msgs) {
		Item oldIdentified = identified;
		identified = newIdentified;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DataPackage.IDENTIFIER__IDENTIFIED, oldIdentified, newIdentified);
	...
	public void setIdentified(Item newIdentified) {
		...
		if (newIdentified != identified) {
			...
			if (identified != null)
				msgs = ((InternalEObject)identified).eInverseRemove(this, DataPackage.ITEM__IDENTIFIED_BY, Item.class, msgs);
			if (newIdentified != null)
				msgs = ((InternalEObject)newIdentified).eInverseAdd(this, DataPackage.ITEM__IDENTIFIED_BY, Item.class, msgs);
			msgs = basicSetIdentified(newIdentified, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataPackage.IDENTIFIER__IDENTIFIED:
				if (identified != null)
					msgs = ((InternalEObject)identified).eInverseRemove(this, DataPackage.ITEM__IDENTIFIED_BY, Item.class, msgs);
				return basicSetIdentified((Item)otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataPackage.IDENTIFIER__IDENTIFIED:
				return basicSetIdentified(null, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.IDENTIFIER__KEY:
				return getKey();
			case DataPackage.IDENTIFIER__VALUE:
				return getValue();
			case DataPackage.IDENTIFIER__IDENTIFIED:
				if (resolve) return getIdentified();
				return basicGetIdentified();
		}
	...
	/**
	 * Generates an EObjectCondition to check whether an Object is of the type Identifier.
	 * 
	 * @return An EObjectCondition whether the Object is of the type Identifier.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		return new EObjectTypeRelationCondition(DataPackageImpl.eINSTANCE.getIdentifier());
	}
	/**
	...
	protected Object getFeature(String featureName) throws UnknownOperationException {
		...
		if ( featureName.equalsIgnoreCase("identified") )
	...
	protected Object setFeature(String featureName, Object value) throws WrongArgException, UnknownOperationException {
		if ( featureName.equalsIgnoreCase("key") ) {
				...
				try {
					...
					throw new WrongArgException("Identifier.setFeature", "java.lang.String",value.getClass().getName());
				}
				this.setKey(fkey);
			return this;
			}		
		...
		if ( featureName.equalsIgnoreCase("identified") ) {
				org.sociotech.communitymashup.data.Item fidentified = null;
				try {
					try {
						fidentified = (org.sociotech.communitymashup.data.Item)(RestUtil.fromInput(value));
					} catch (ClassNotFoundException e) {
						fidentified = (org.sociotech.communitymashup.data.Item)value;
					}
				} catch (ClassCastException e) {
					throw new WrongArgException("Identifier.setFeature", "org.sociotech.communitymashup.data.Item",value.getClass().getName());
				}
				this.setIdentified(fidentified);
			return this;
			}			
	...
	public Boolean isEqualItem(Item item) {
		if(item == null || item.eClass() != this.eClass())
		{
			return false;
		}
		
		// cast to identifier
		Identifier itemIdentifier = (Identifier) item;
		...
		{
			equal &= this.getValue().equals(itemIdentifier.getValue());
		}
		else
		{
			// if both null they are equal
			equal &= (itemIdentifier.getValue() == null);
		}
	
		if(this.getKey() != null)
		{
			equal &= this.getKey().equals(itemIdentifier.getKey());
		}
		else
		{
			// if both null they are equal
			equal &= (itemIdentifier.getKey() == null);
		}
