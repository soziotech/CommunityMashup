 ...
 * <ul>
 *   <li>{@link org.sociotech.communitymashup.data.impl.RankingImpl#getDate <em>Date</em>}</li>
 *   <li>{@link org.sociotech.communitymashup.data.impl.RankingImpl#getRanker <em>Ranker</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class RankingImpl extends ExtensionImpl implements Ranking {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getRanker() <em>Ranker</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRanker()
	 * @generated
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.RANKING;
	}
	...
	public void setDate(Date newDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.RANKING__DATE, oldDate, date));
	}
	 ...
	 * @generated
	 */
	public Person getRanker() {
		if (ranker != null && ranker.eIsProxy()) {
			InternalEObject oldRanker = (InternalEObject)ranker;
			ranker = (Person)eResolveProxy(oldRanker);
			if (ranker != oldRanker) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataPackage.RANKING__RANKER, oldRanker, ranker));
			}
		}
		return ranker;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetRanker(Person newRanker, NotificationChain msgs) {
		Person oldRanker = ranker;
		ranker = newRanker;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DataPackage.RANKING__RANKER, oldRanker, newRanker);
	 ...
	 * @generated
	 */
	public void setRanker(Person newRanker) {
		if (newRanker != ranker) {
			NotificationChain msgs = null;
			if (ranker != null)
				msgs = ((InternalEObject)ranker).eInverseRemove(this, DataPackage.PERSON__RANKED, Person.class, msgs);
			if (newRanker != null)
				msgs = ((InternalEObject)newRanker).eInverseAdd(this, DataPackage.PERSON__RANKED, Person.class, msgs);
			msgs = basicSetRanker(newRanker, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.RANKING__RANKER, newRanker, newRanker));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataPackage.RANKING__RANKER:
				if (ranker != null)
					msgs = ((InternalEObject)ranker).eInverseRemove(this, DataPackage.PERSON__RANKED, Person.class, msgs);
				return basicSetRanker((Person)otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataPackage.RANKING__RANKER:
				return basicSetRanker(null, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.RANKING__DATE:
				return getDate();
			case DataPackage.RANKING__RANKER:
				if (resolve) return getRanker();
				return basicGetRanker();
		}
	...
	/**
	 * Generates an EObjectCondition to check whether an Object is of the type Ranking.
	 * 
	 * @return An EObjectCondition whether the Object is of the type Ranking.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		EObjectCondition result = new EObjectTypeRelationCondition(DataPackageImpl.eINSTANCE.getRanking());
		return result.OR(StarRanking.isTypeCondition).OR(ViewRanking.isTypeCondition).OR(ThumbRanking.isTypeCondition);
	}
	...
	protected Object getFeature(String featureName) throws UnknownOperationException {
		if ( featureName.equalsIgnoreCase("date") )
			return this.getDate();		
		if ( featureName.equalsIgnoreCase("ranker") )
	...
	protected Object setFeature(String featureName, Object value) throws WrongArgException, UnknownOperationException {
		if ( featureName.equalsIgnoreCase("date") ) {
				...
				try {
					...
					throw new WrongArgException("Ranking.setFeature", "java.util.Date",value.getClass().getName());
				}
				this.setDate(fdate);
			return this;
			}		
		if ( featureName.equalsIgnoreCase("ranker") ) {
				org.sociotech.communitymashup.data.Person franker = null;
				try {
					try {
						franker = (org.sociotech.communitymashup.data.Person)(RestUtil.fromInput(value));
					} catch (ClassNotFoundException e) {
						franker = (org.sociotech.communitymashup.data.Person)value;
					}
				} catch (ClassCastException e) {
					throw new WrongArgException("Ranking.setFeature", "org.sociotech.communitymashup.data.Person",value.getClass().getName());
				}
				this.setRanker(franker);
			return this;
			}			
