...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Instant Messenger</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.sociotech.communitymashup.data.impl.InstantMessengerImpl#getUsername <em>Username</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InstantMessengerImpl extends MetaInformationImpl implements InstantMessenger {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	protected InstantMessengerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.INSTANT_MESSENGER;
	}
	...
	public void setUsername(String newUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.INSTANT_MESSENGER__USERNAME, oldUsername, username));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.INSTANT_MESSENGER__USERNAME:
				return getUsername();
		}
	...
	/**
	 * Generates an EObjectCondition to check whether an Object is of the type InstantMessenger.
	 * 
	 * @return An EObjectCondition whether the Object is of the type InstantMessenger.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		return new EObjectTypeRelationCondition(DataPackageImpl.eINSTANCE.getInstantMessenger());
	}
	...
	protected Object setFeature(String featureName, Object value) throws WrongArgException, UnknownOperationException {
		if ( featureName.equalsIgnoreCase("username") ) {
				java.lang.String fusername = null;
				try {
					fusername = (java.lang.String)value;
				} catch (ClassCastException e) {
					throw new WrongArgException("InstantMessenger.setFeature", "java.lang.String",value.getClass().getName());
				}
