...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Thumb Ranking</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.sociotech.communitymashup.data.impl.ThumbRankingImpl#getRankedInformationObject <em>Ranked Information Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ThumbRankingImpl extends RankingImpl implements ThumbRanking {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.THUMB_RANKING;
	}
		...
		if (rankedInformationObject != null && rankedInformationObject.eIsProxy()) {
			...
			if (rankedInformationObject != oldRankedInformationObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataPackage.THUMB_RANKING__RANKED_INFORMATION_OBJECT, oldRankedInformationObject, rankedInformationObject));
			}
		}
	...
	public NotificationChain basicSetRankedInformationObject(InformationObject newRankedInformationObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DataPackage.THUMB_RANKING__RANKED_INFORMATION_OBJECT, oldRankedInformationObject, newRankedInformationObject);
	...
	public void setRankedInformationObject(InformationObject newRankedInformationObject) {
		if (newRankedInformationObject != rankedInformationObject) {
			...
			if (rankedInformationObject != null)
				msgs = ((InternalEObject)rankedInformationObject).eInverseRemove(this, DataPackage.INFORMATION_OBJECT__THUMB_RANKINGS, InformationObject.class, msgs);
			if (newRankedInformationObject != null)
				msgs = ((InternalEObject)newRankedInformationObject).eInverseAdd(this, DataPackage.INFORMATION_OBJECT__THUMB_RANKINGS, InformationObject.class, msgs);
			msgs = basicSetRankedInformationObject(newRankedInformationObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.THUMB_RANKING__RANKED_INFORMATION_OBJECT, newRankedInformationObject, newRankedInformationObject));
	}
	...
	public Boolean isThumbUp() {
		return this.getStringValue().equals(THUMBS_UP_VALUE);
	}
	...
	public Boolean isThumbDown() {
		return this.getStringValue().equals(THUMBS_DOWN_VALUE);
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataPackage.THUMB_RANKING__RANKED_INFORMATION_OBJECT:
				if (rankedInformationObject != null)
					msgs = ((InternalEObject)rankedInformationObject).eInverseRemove(this, DataPackage.INFORMATION_OBJECT__THUMB_RANKINGS, InformationObject.class, msgs);
	...
	/**
	 * Generates an EObjectCondition to check whether an Object is of the type ThumbRanking.
	 * 
	 * @return An EObjectCondition whether the Object is of the type ThumbRanking.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		return new EObjectTypeRelationCondition(DataPackageImpl.eINSTANCE.getThumbRanking());
	}
	...
	protected Object setFeature(String featureName, Object value) throws WrongArgException, UnknownOperationException {
		if ( featureName.equalsIgnoreCase("rankedInformationObject") ) {
				...
				try {
					...
					throw new WrongArgException("ThumbRanking.setFeature", "org.sociotech.communitymashup.data.InformationObject",value.getClass().getName());
				}
	...
	protected Object doOperation(RestCommand command) throws ArgNotFoundException, WrongArgException, WrongArgCountException, UnknownOperationException {
		if ( command.getCommand().equalsIgnoreCase("isThumbUp")) {
			if (command.getArgCount() != 0) throw new WrongArgCountException("ThumbRanking.doOperation", 0, command.getArgCount()); 
			return this.isThumbUp();
		}
		if ( command.getCommand().equalsIgnoreCase("isThumbDown")) {
			if (command.getArgCount() != 0) throw new WrongArgCountException("ThumbRanking.doOperation", 0, command.getArgCount()); 
