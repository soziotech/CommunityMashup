 ...
 * <ul>
 *   <li>{@link org.sociotech.communitymashup.data.impl.BinaryImpl#getBytes <em>Bytes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BinaryImpl extends AttachmentImpl implements Binary {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.BINARY;
	}
	...
	public void setBytes(byte[] newBytes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.BINARY__BYTES, oldBytes, bytes));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.BINARY__BYTES:
				return getBytes();
		}
	...
	/**
	 * Generates an EObjectCondition to check whether an Object is of the type Binary.
	 * 
	 * @return An EObjectCondition whether the Object is of the type Binary.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		return new EObjectTypeRelationCondition(DataPackageImpl.eINSTANCE.getBinary());
	}
	/**
	...
	protected Object getFeature(String featureName) throws UnknownOperationException {
		if ( featureName.equalsIgnoreCase("bytes") )
	...
	protected Object setFeature(String featureName, Object value) throws WrongArgException, UnknownOperationException {
		if ( featureName.equalsIgnoreCase("bytes") ) {
				...
				try {
					try {
						fbytes = (byte[])(RestUtil.fromInput(value));
					} catch (ClassNotFoundException e) {
						fbytes = (byte[])value;
					}
				} catch (ClassCastException e) {
					throw new WrongArgException("Binary.setFeature", "byte[]",value.getClass().getName());
				}
				this.setBytes(fbytes);
			return this;
			}			
