 ...
 * @generated
 */
public abstract class ExtensionImpl extends ItemImpl implements Extension {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.EXTENSION;
	}
	...
	/**
	 * Generates an EObjectCondition to check whether an Object is of the type Extension.
	 * 
	 * @return An EObjectCondition whether the Object is of the type Extension.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		EObjectCondition result = new EObjectTypeRelationCondition(DataPackageImpl.eINSTANCE.getExtension());
		return result.OR(Ranking.isTypeCondition).OR(Attachment.isTypeCondition).OR(Connection.isTypeCondition).OR(MetaInformation.isTypeCondition);
	}
	...
	protected Object doOperation(RestCommand command) throws ArgNotFoundException, WrongArgException, WrongArgCountException, UnknownOperationException {
		if ( command.getCommand().equalsIgnoreCase("tag")) {
			if (command.getArgCount() != 1) throw new WrongArgCountException("Extension.doOperation", 1, command.getArgCount()); 
			java.lang.String name = null;
			try {
				name = (java.lang.String)command.getArg("name");
			} catch (ClassCastException e) {
				throw new WrongArgException("Extension.doOperation", "java.lang.String", command.getArg("name").getClass().getName());
			}
