 ...
 * <ul>
 *   <li>{@link org.sociotech.communitymashup.data.impl.MetaInformationImpl#getInformationObjects <em>Information Objects</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MetaInformationImpl extends ExtensionImpl implements MetaInformation {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getInformationObjects() <em>Information Objects</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getInformationObjects()
	 * @generated
	 * @ordered
	 */
	protected EList<InformationObject> informationObjects;
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.META_INFORMATION;
	}
	...
	public EList<InformationObject> getInformationObjects() {
		if (informationObjects == null) {
			informationObjects = new EObjectWithInverseResolvingEList.ManyInverse<InformationObject>(InformationObject.class, this, DataPackage.META_INFORMATION__INFORMATION_OBJECTS, DataPackage.INFORMATION_OBJECT__META_INFORMATIONS);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataPackage.META_INFORMATION__INFORMATION_OBJECTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getInformationObjects()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataPackage.META_INFORMATION__INFORMATION_OBJECTS:
				return ((InternalEList<?>)getInformationObjects()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case DataPackage.META_INFORMATION__INFORMATION_OBJECTS:
				getInformationObjects().clear();
				getInformationObjects().addAll((Collection<? extends InformationObject>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case DataPackage.META_INFORMATION__INFORMATION_OBJECTS:
				return informationObjects != null && !informationObjects.isEmpty();
		}
	...
	/**
	 * Generates an EObjectCondition to check whether an Object is of the type MetaInformation.
	 * 
	 * @return An EObjectCondition whether the Object is of the type MetaInformation.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		EObjectCondition result = new EObjectTypeRelationCondition(DataPackageImpl.eINSTANCE.getMetaInformation());
		return result.OR(Phone.isTypeCondition).OR(InstantMessenger.isTypeCondition).OR(Email.isTypeCondition).OR(WebAccount.isTypeCondition).OR(WebSite.isTypeCondition).OR(Location.isTypeCondition).OR(IndoorLocation.isTypeCondition).OR(Event.isTypeCondition);
	}
	/**
	...
	protected Object getFeature(String featureName) throws UnknownOperationException {
		if ( featureName.equalsIgnoreCase("informationObjects") )
	...
	protected void deleteIfUnused() {
		if(getInformationObjects().isEmpty())
		{
			// delete if no more information objects are extended by this meta information
			// might be overwritten in concrete subclasses
			this.delete();
		}
	}
