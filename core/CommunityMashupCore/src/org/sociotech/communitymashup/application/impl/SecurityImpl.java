 ...
 * <ul>
 *   <li>{@link org.sociotech.communitymashup.application.impl.SecurityImpl#getInterface <em>Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class SecurityImpl extends EObjectImpl implements Security {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return ApplicationPackage.Literals.SECURITY;
	}
	...
	public Interface getInterface() {
		if (eContainerFeatureID() != ApplicationPackage.SECURITY__INTERFACE) return null;
	...
	public NotificationChain basicSetInterface(Interface newInterface, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newInterface, ApplicationPackage.SECURITY__INTERFACE, msgs);
		return msgs;
	}
	...
	public void setInterface(Interface newInterface) {
		if (newInterface != eInternalContainer() || (eContainerFeatureID() != ApplicationPackage.SECURITY__INTERFACE && newInterface != null)) {
			...
			if (newInterface != null)
				msgs = ((InternalEObject)newInterface).eInverseAdd(this, ApplicationPackage.INTERFACE__SECURITY, Interface.class, msgs);
			msgs = basicSetInterface(newInterface, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApplicationPackage.SECURITY__INTERFACE, newInterface, newInterface));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ApplicationPackage.SECURITY__INTERFACE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ApplicationPackage.SECURITY__INTERFACE:
				return eInternalContainer().eInverseRemove(this, ApplicationPackage.INTERFACE__SECURITY, Interface.class, msgs);
		}
	...
	/**
	 * Generates an EObjectCondition to check whether an Object is of the type Security.
	 * 
	 * @return An EObjectCondition whether the Object is of the type Security.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		EObjectCondition result = new EObjectTypeRelationCondition(ApplicationPackageImpl.eINSTANCE.getSecurity());
		return result.OR(OAuthConfig.isTypeCondition).OR(ApplicationKeyConfig.isTypeCondition);
	}
	...
	protected Object getFeature(String featureName) throws UnknownOperationException {
		if ( featureName.equalsIgnoreCase("interface") )
	...
	protected Object setFeature(String featureName, Object value) throws WrongArgException, UnknownOperationException {
		if ( featureName.equalsIgnoreCase("interface") ) {
				org.sociotech.communitymashup.application.Interface finterface = null;
				try {
					try {
						finterface = (org.sociotech.communitymashup.application.Interface)(RestUtil.fromInput(value));
					} catch (ClassNotFoundException e) {
						finterface = (org.sociotech.communitymashup.application.Interface)value;
					}
				} catch (ClassCastException e) {
					throw new WrongArgException("Security.setFeature", "org.sociotech.communitymashup.application.Interface",value.getClass().getName());
				}
