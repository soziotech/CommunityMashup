...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>XML File</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class XMLFileImpl extends PersistencyImpl implements XMLFile {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return ApplicationPackage.Literals.XML_FILE;
	}


	
	/**
	 * Generates an EObjectCondition to check whether an Object is of the type XMLFile.
	 * 
	 * @return An EObjectCondition whether the Object is of the type XMLFile.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		return new EObjectTypeRelationCondition(ApplicationPackageImpl.eINSTANCE.getXMLFile());
	}
