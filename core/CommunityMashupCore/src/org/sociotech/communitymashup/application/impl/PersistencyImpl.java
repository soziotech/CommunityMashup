...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Persistency</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class PersistencyImpl extends EObjectImpl implements Persistency {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return ApplicationPackage.Literals.PERSISTENCY;
	}


	
	/**
	 * Generates an EObjectCondition to check whether an Object is of the type Persistency.
	 * 
	 * @return An EObjectCondition whether the Object is of the type Persistency.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		EObjectCondition result = new EObjectTypeRelationCondition(ApplicationPackageImpl.eINSTANCE.getPersistency());
		return result.OR(XMLFile.isTypeCondition).OR(Database.isTypeCondition);
	}
