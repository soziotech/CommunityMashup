...
public class MappingRuleImpl extends EObjectImpl implements MappingRule {
	...
	protected EClass eStaticClass() {
		return ApplicationPackage.Literals.MAPPING_RULE;
	}


	
	/**
	 * Generates an EObjectCondition to check whether an Object is of the type MappingRule.
	 * 
	 * @return An EObjectCondition whether the Object is of the type MappingRule.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		return new EObjectTypeRelationCondition(ApplicationPackageImpl.eINSTANCE.getMappingRule());
	}
