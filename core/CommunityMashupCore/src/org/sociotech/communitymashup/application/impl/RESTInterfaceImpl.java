 ...
 * <ul>
 *   <li>{@link org.sociotech.communitymashup.application.impl.RESTInterfaceImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RESTInterfaceImpl extends InterfaceImpl implements RESTInterface {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return ApplicationPackage.Literals.REST_INTERFACE;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApplicationPackage.REST_INTERFACE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ApplicationPackage.REST_INTERFACE__TYPE:
				return getType();
		}
	...
	/**
	 * Generates an EObjectCondition to check whether an Object is of the type RESTInterface.
	 * 
	 * @return An EObjectCondition whether the Object is of the type RESTInterface.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		return new EObjectTypeRelationCondition(ApplicationPackageImpl.eINSTANCE.getRESTInterface());
	}
	...
	protected Object setFeature(String featureName, Object value) throws WrongArgException, UnknownOperationException {
		if ( featureName.equalsIgnoreCase("type") ) {
				...
				try {
					...
					throw new WrongArgException("RESTInterface.setFeature", "java.lang.String",value.getClass().getName());
				}
				this.setType(ftype);
			return this;
			}			
