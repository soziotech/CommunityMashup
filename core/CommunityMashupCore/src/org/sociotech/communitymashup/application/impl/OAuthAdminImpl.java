...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>OAuth Admin</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.sociotech.communitymashup.application.impl.OAuthAdminImpl#getUsername <em>Username</em>}</li>
 *   <li>{@link org.sociotech.communitymashup.application.impl.OAuthAdminImpl#getPasswordHash <em>Password Hash</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OAuthAdminImpl extends EObjectImpl implements OAuthAdmin {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return ApplicationPackage.Literals.OAUTH_ADMIN;
	}
	...
	public void setUsername(String newUsername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApplicationPackage.OAUTH_ADMIN__USERNAME, oldUsername, username));
	}
	...
	public void setPasswordHash(String newPasswordHash) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ApplicationPackage.OAUTH_ADMIN__PASSWORD_HASH, oldPasswordHash, passwordHash));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ApplicationPackage.OAUTH_ADMIN__USERNAME:
				return getUsername();
			case ApplicationPackage.OAUTH_ADMIN__PASSWORD_HASH:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ApplicationPackage.OAUTH_ADMIN__PASSWORD_HASH:
				return PASSWORD_HASH_EDEFAULT == null ? passwordHash != null : !PASSWORD_HASH_EDEFAULT.equals(passwordHash);
		}
	...
	/**
	 * Generates an EObjectCondition to check whether an Object is of the type OAuthAdmin.
	 * 
	 * @return An EObjectCondition whether the Object is of the type OAuthAdmin.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		return new EObjectTypeRelationCondition(ApplicationPackageImpl.eINSTANCE.getOAuthAdmin());
	}
	...
	protected Object getFeature(String featureName) throws UnknownOperationException {
		...
		if ( featureName.equalsIgnoreCase("passwordHash") )
	...
	protected Object setFeature(String featureName, Object value) throws WrongArgException, UnknownOperationException {
		if ( featureName.equalsIgnoreCase("username") ) {
				...
				try {
					...
					throw new WrongArgException("OAuthAdmin.setFeature", "java.lang.String",value.getClass().getName());
				}
				this.setUsername(fusername);
			return this;
			}		
		if ( featureName.equalsIgnoreCase("passwordHash") ) {
				java.lang.String fpasswordHash = null;
				try {
					fpasswordHash = (java.lang.String)value;
				} catch (ClassCastException e) {
					throw new WrongArgException("OAuthAdmin.setFeature", "java.lang.String",value.getClass().getName());
				}
				this.setPasswordHash(fpasswordHash);
			return this;
			}		
