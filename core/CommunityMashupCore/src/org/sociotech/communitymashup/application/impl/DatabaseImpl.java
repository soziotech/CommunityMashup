 ...
 * @generated
 */
public class DatabaseImpl extends PersistencyImpl implements Database {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return ApplicationPackage.Literals.DATABASE;
	}

	/**
	 * Generates an EObjectCondition to check whether an Object is of the type Database.
	 * 
	 * @return An EObjectCondition whether the Object is of the type Database.
	 * @generated
	 */
	public static EObjectCondition generateIsTypeCondition() {
		return new EObjectTypeRelationCondition(ApplicationPackageImpl.eINSTANCE.getDatabase());
	}
