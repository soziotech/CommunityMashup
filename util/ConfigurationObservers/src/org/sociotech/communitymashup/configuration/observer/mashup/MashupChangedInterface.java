 ...
 */
public interface MashupChangedInterface {

	/**
	 * This method will be call if the observed mashup gets changed
	 * 
	 * @param notification The EMF notification
	 */
	void mashupConfigurationChanged(Notification notification);
